!function(e,n){"function"==typeof define&&(define.amd||define.cmd)?define(n):"object"==typeof exports?module.exports=n():e.Browser=n()}(this,function(){var l=this||{},O="undefined"!=typeof navigator?navigator:{},x=function(e,n){var r=navigator.mimeTypes;for(var i in r)if(r[i][e]==n)return!0;return!1};return function(e){var n=e||O.userAgent||{},r=this,i={Trident:-1<n.indexOf("Trident")||-1<n.indexOf("NET CLR"),Presto:-1<n.indexOf("Presto"),WebKit:-1<n.indexOf("AppleWebKit"),Gecko:-1<n.indexOf("Gecko/"),Safari:-1<n.indexOf("Safari"),Chrome:-1<n.indexOf("Chrome")||-1<n.indexOf("CriOS"),IE:-1<n.indexOf("MSIE")||-1<n.indexOf("Trident"),Edge:-1<n.indexOf("Edge"),Firefox:-1<n.indexOf("Firefox")||-1<n.indexOf("FxiOS"),"Firefox Focus":-1<n.indexOf("Focus"),Chromium:-1<n.indexOf("Chromium"),Opera:-1<n.indexOf("Opera")||-1<n.indexOf("OPR"),Vivaldi:-1<n.indexOf("Vivaldi"),Yandex:-1<n.indexOf("YaBrowser"),Arora:-1<n.indexOf("Arora"),Lunascape:-1<n.indexOf("Lunascape"),QupZilla:-1<n.indexOf("QupZilla"),"Coc Coc":-1<n.indexOf("coc_coc_browser"),Kindle:-1<n.indexOf("Kindle")||-1<n.indexOf("Silk/"),Iceweasel:-1<n.indexOf("Iceweasel"),Konqueror:-1<n.indexOf("Konqueror"),Iceape:-1<n.indexOf("Iceape"),SeaMonkey:-1<n.indexOf("SeaMonkey"),Epiphany:-1<n.indexOf("Epiphany"),360:-1<n.indexOf("QihooBrowser"),"360EE":-1<n.indexOf("360EE"),"360SE":-1<n.indexOf("360SE"),UC:-1<n.indexOf("UC")||-1<n.indexOf(" UBrowser"),QQBrowser:-1<n.indexOf("QQBrowser"),QQ:-1<n.indexOf("QQ/"),Baidu:-1<n.indexOf("Baidu")||-1<n.indexOf("BIDUBrowser"),Maxthon:-1<n.indexOf("Maxthon"),Sogou:-1<n.indexOf("MetaSr")||-1<n.indexOf("Sogou"),LBBROWSER:-1<n.indexOf("LBBROWSER"),"2345Explorer":-1<n.indexOf("2345Explorer"),TheWorld:-1<n.indexOf("TheWorld"),XiaoMi:-1<n.indexOf("MiuiBrowser"),Quark:-1<n.indexOf("Quark"),Qiyu:-1<n.indexOf("Qiyu"),Wechat:-1<n.indexOf("MicroMessenger"),Taobao:-1<n.indexOf("AliApp(TB"),Alipay:-1<n.indexOf("AliApp(AP"),Weibo:-1<n.indexOf("Weibo"),Douban:-1<n.indexOf("com.douban.frodo"),Suning:-1<n.indexOf("SNEBUY-APP"),iQiYi:-1<n.indexOf("IqiyiApp"),Windows:-1<n.indexOf("Windows"),Linux:-1<n.indexOf("Linux")||-1<n.indexOf("X11"),"Mac OS":-1<n.indexOf("Macintosh"),Android:-1<n.indexOf("Android")||-1<n.indexOf("Adr"),Ubuntu:-1<n.indexOf("Ubuntu"),FreeBSD:-1<n.indexOf("FreeBSD"),Debian:-1<n.indexOf("Debian"),"Windows Phone":-1<n.indexOf("IEMobile")||-1<n.indexOf("Windows Phone"),BlackBerry:-1<n.indexOf("BlackBerry")||-1<n.indexOf("RIM"),MeeGo:-1<n.indexOf("MeeGo"),Symbian:-1<n.indexOf("Symbian"),iOS:-1<n.indexOf("like Mac OS X"),"Chrome OS":-1<n.indexOf("CrOS"),WebOS:-1<n.indexOf("hpwOS"),Mobile:-1<n.indexOf("Mobi")||-1<n.indexOf("iPh")||-1<n.indexOf("480"),Tablet:-1<n.indexOf("Tablet")||-1<n.indexOf("Pad")||-1<n.indexOf("Nexus 7")},o=!1;l.chrome&&(o=x("type","application/vnd.chromium.remoting-viewer"),l.showModalDialog&&36<n.replace(/^.*Chrome\/([\d]+).*$/,"$1")&&(o=!0));if(i.Mobile?i.Mobile=!(-1<n.indexOf("iPad")):o&&(x("type","application/gameplugin")?i["360SE"]=!0:i["360EE"]=!0),i.IE||i.Edge)switch(window.screenTop-window.screenY){case 71:case 74:case 99:case 102:i["360EE"]=!0;break;case 75:case 74:case 105:case 104:i["360SE"]=!0}var a,d={engine:["WebKit","Trident","Gecko","Presto"],browser:["Safari","Chrome","Edge","IE","Firefox","Firefox Focus","Chromium","Opera","Vivaldi","Yandex","Arora","Lunascape","QupZilla","Coc Coc","Kindle","Iceweasel","Konqueror","Iceape","SeaMonkey","Epiphany","360","360SE","360EE","UC","QQBrowser","QQ","Baidu","Maxthon","Sogou","LBBROWSER","2345Explorer","TheWorld","XiaoMi","Quark","Qiyu","Wechat","Taobao","Alipay","Weibo","Douban","Suning","iQiYi"],os:["Windows","Linux","Mac OS","Android","Ubuntu","FreeBSD","Debian","iOS","Windows Phone","BlackBerry","MeeGo","Symbian","Chrome OS","WebOS"],device:["Mobile","Tablet"]};for(var c in r.device="PC",r.language=((a=(O.browserLanguage||O.language).split("-"))[1]&&(a[1]=a[1].toUpperCase()),a.join("_")),d)for(var u=0;u<d[c].length;u++){var f=d[c][u];i[f]&&(r[c]=f)}var t={Windows:function(){var e=n.replace(/^.*Windows NT ([\d.]+);.*$/,"$1");return{6.4:"10",6.3:"8.1",6.2:"8",6.1:"7","6.0":"Vista",5.2:"XP",5.1:"XP","5.0":"2000"}[e]||e},Android:function(){return n.replace(/^.*Android ([\d.]+);.*$/,"$1")},iOS:function(){return n.replace(/^.*OS ([\d_]+) like.*$/,"$1").replace(/_/g,".")},Debian:function(){return n.replace(/^.*Debian\/([\d.]+).*$/,"$1")},"Windows Phone":function(){return n.replace(/^.*Windows Phone( OS)? ([\d.]+);.*$/,"$2")},"Mac OS":function(){return n.replace(/^.*Mac OS X ([\d_]+).*$/,"$1").replace(/_/g,".")},WebOS:function(){return n.replace(/^.*hpwOS\/([\d.]+);.*$/,"$1")}};r.osVersion="",t[r.os]&&(r.osVersion=t[r.os](),r.osVersion==n&&(r.osVersion=""));var p={Safari:function(){return n.replace(/^.*Version\/([\d.]+).*$/,"$1")},Chrome:function(){return n.replace(/^.*Chrome\/([\d.]+).*$/,"$1").replace(/^.*CriOS\/([\d.]+).*$/,"$1")},IE:function(){return n.replace(/^.*MSIE ([\d.]+).*$/,"$1").replace(/^.*rv:([\d.]+).*$/,"$1")},Edge:function(){return n.replace(/^.*Edge\/([\d.]+).*$/,"$1")},Firefox:function(){return n.replace(/^.*Firefox\/([\d.]+).*$/,"$1").replace(/^.*FxiOS\/([\d.]+).*$/,"$1")},"Firefox Focus":function(){return n.replace(/^.*Focus\/([\d.]+).*$/,"$1")},Chromium:function(){return n.replace(/^.*Chromium\/([\d.]+).*$/,"$1")},Opera:function(){return n.replace(/^.*Opera\/([\d.]+).*$/,"$1").replace(/^.*OPR\/([\d.]+).*$/,"$1")},Vivaldi:function(){return n.replace(/^.*Vivaldi\/([\d.]+).*$/,"$1")},Yandex:function(){return n.replace(/^.*YaBrowser\/([\d.]+).*$/,"$1")},Arora:function(){return n.replace(/^.*Arora\/([\d.]+).*$/,"$1")},Lunascape:function(){return n.replace(/^.*Lunascape[\/\s]([\d.]+).*$/,"$1")},QupZilla:function(){return n.replace(/^.*QupZilla[\/\s]([\d.]+).*$/,"$1")},"Coc Coc":function(){return n.replace(/^.*coc_coc_browser\/([\d.]+).*$/,"$1")},Kindle:function(){return n.replace(/^.*Version\/([\d.]+).*$/,"$1")},Iceweasel:function(){return n.replace(/^.*Iceweasel\/([\d.]+).*$/,"$1")},Konqueror:function(){return n.replace(/^.*Konqueror\/([\d.]+).*$/,"$1")},Iceape:function(){return n.replace(/^.*Iceape\/([\d.]+).*$/,"$1")},SeaMonkey:function(){return n.replace(/^.*SeaMonkey\/([\d.]+).*$/,"$1")},Epiphany:function(){return n.replace(/^.*Epiphany\/([\d.]+).*$/,"$1")},360:function(){return n.replace(/^.*QihooBrowser\/([\d.]+).*$/,"$1")},"360SE":function(){return{55:"9.1",45:"8.1",42:"8.0",31:"7.0",21:"6.3"}[n.replace(/^.*Chrome\/([\d]+).*$/,"$1")]||""},"360EE":function(){return{63:"9.5",55:"9.0",50:"8.7",30:"7.5"}[n.replace(/^.*Chrome\/([\d]+).*$/,"$1")]||""},Maxthon:function(){return n.replace(/^.*Maxthon\/([\d.]+).*$/,"$1")},QQBrowser:function(){return n.replace(/^.*QQBrowser\/([\d.]+).*$/,"$1")},QQ:function(){return n.replace(/^.*QQ\/([\d.]+).*$/,"$1")},Baidu:function(){return n.replace(/^.*BIDUBrowser[\s\/]([\d.]+).*$/,"$1")},UC:function(){return n.replace(/^.*UC?Browser\/([\d.]+).*$/,"$1")},Sogou:function(){return n.replace(/^.*SE ([\d.X]+).*$/,"$1").replace(/^.*SogouMobileBrowser\/([\d.]+).*$/,"$1")},LBBROWSER:function(){return{57:"6.5",49:"6.0",46:"5.9",42:"5.3",39:"5.2",34:"5.0",29:"4.5",21:"4.0"}[navigator.userAgent.replace(/^.*Chrome\/([\d]+).*$/,"$1")]||""},"2345Explorer":function(){return n.replace(/^.*2345Explorer\/([\d.]+).*$/,"$1")},TheWorld:function(){return n.replace(/^.*TheWorld ([\d.]+).*$/,"$1")},XiaoMi:function(){return n.replace(/^.*MiuiBrowser\/([\d.]+).*$/,"$1")},Quark:function(){return n.replace(/^.*Quark\/([\d.]+).*$/,"$1")},Qiyu:function(){return n.replace(/^.*Qiyu\/([\d.]+).*$/,"$1")},Wechat:function(){return n.replace(/^.*MicroMessenger\/([\d.]+).*$/,"$1")},Taobao:function(){return n.replace(/^.*AliApp\(TB\/([\d.]+).*$/,"$1")},Alipay:function(){return n.replace(/^.*AliApp\(AP\/([\d.]+).*$/,"$1")},Weibo:function(){return n.replace(/^.*weibo__([\d.]+).*$/,"$1")},Douban:function(){return n.replace(/^.*com.douban.frodo\/([\d.]+).*$/,"$1")},Suning:function(){return n.replace(/^.*SNEBUY-APP([\d.]+).*$/,"$1")},iQiYi:function(){return n.replace(/^.*IqiyiVersion\/([\d.]+).*$/,"$1")}};r.version="",p[r.browser]&&(r.version=p[r.browser](),r.version==n&&(r.version="")),"Edge"==r.browser?r.engine="EdgeHTML":"Chrome"==r.browser&&27<parseInt(r.version)?r.engine="Blink":"Opera"==r.browser&&12<parseInt(r.version)?r.engine="Blink":"Yandex"==r.browser&&(r.engine="Blink")}});
!function(){var o,r="//res.wx.qq.com/open/js/jweixin-1.0.0.js",s="//open.mobile.qq.com/sdk/qqapi.js?_bid=152",l="//qzonestyle.gtimg.cn/qzone/phone/m/v4/widget/mobile/jsbridge.js?_bid=339";function e(e){var t,n=navigator.userAgent,i=n.match(/MicroMessenger\/([\d\.]+)/),a=n.match(/QQ\/([\d\.]+)/),c=-1!==n.indexOf("Qzone/");i&&((t=e).WXconfig&&o([r],function(n){n.config||(n=window.wx);var i=t.WXconfig;n.config({debug:!1,appId:i.appId,timestamp:i.timestamp,nonceStr:i.nonceStr,signature:i.signature,jsApiList:["onMenuShareTimeline","onMenuShareAppMessage","onMenuShareQQ","onMenuShareQZone"]}),n.error(function(e){}),n.ready(function(){var e={title:t.title,desc:t.summary,link:t.url,imgUrl:t.pic,type:"",dataUrl:"",success:function(){t.callback&&t.callback()},cancel:function(){}};n.onMenuShareAppMessage(e),n.onMenuShareQQ(e),n.onMenuShareQZone(e),i.swapTitleInWX?n.onMenuShareTimeline({title:t.summary,desc:t.title,link:t.url,imgUrl:t.pic,type:"",dataUrl:"",success:function(){t.callback&&t.callback()},cancel:function(){}}):n.onMenuShareTimeline(e)})})),a&&function(n){var i={title:n.title,desc:n.summary,share_url:n.url,image_url:n.pic};function e(){try{n.callback?window.mqq.ui.setOnShareHandler(function(e){3==e&&(n.swapTitle||n.WXconfig&&n.WXconfig.swapTitleInWX)?i.title=n.summary:i.title=n.title,i.share_type=e,i.back=!0,window.mqq.ui.shareMessage(i,function(e){0===e.retCode&&n.callback&&n.callback.call(this,e)})}):window.mqq.data.setShareInfo(i)}catch(e){}}window.mqq?e():o([s],function(){e()})}(e),c&&function(c){function e(){if(QZAppExternal&&QZAppExternal.setShare){for(var e=[],n=[],i=[],t=[],a=0;a<5;a++)e.push(c.pic),t.push(c.url),4===a&&(c.swapTitle||c.WXconfig&&c.WXconfig.swapTitleInWX)?(n.push(c.summary),i.push(c.title)):(n.push(c.title),i.push(c.summary));QZAppExternal.setShare(function(e){},{type:"share",image:e,title:n,summary:i,shareURL:t})}}window.QZAppExternal?e():o([l],function(){e()})}(e)}"function"==typeof define&&(define.cmd||define.amd)?(define.cmd?o=seajs.use:define.amd&&(o=window.require),define(function(){return e})):(o=function(e,n){var i=document,t=i.head||i.getElementsByTagName("head")[0]||i.documentElement,a=i.createElement("script");a.onload=n,a.onerror=function(){},a.async=!0,a.src=e[0],t.appendChild(a)},window.setShareInfo=e)}();
